...
class UploadedFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create uploaded_file" do
    assert_difference('UploadedFile.count') do
      post uploaded_files_url, params: { uploaded_file: { active: @uploaded_file.active, media_type: @uploaded_file.media_type, name: @uploaded_file.name, upload_date: @uploaded_file.upload_date, url: @uploaded_file.url } }
    end
  ...
  test "should update uploaded_file" do
    patch uploaded_file_url(@uploaded_file), params: { uploaded_file: { active: @uploaded_file.active, media_type: @uploaded_file.media_type, name: @uploaded_file.name, upload_date: @uploaded_file.upload_date, url: @uploaded_file.url } }
